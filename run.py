...
if __name__ == '__main__':
    #socketio.run(app, debug=False,port=3000) #use this one for local testing
    socketio.run(app, debug=False,host="0.0.0.0",port=3000) #use this one to host for other computers
